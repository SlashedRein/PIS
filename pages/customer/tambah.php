...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO customer (nama, alamat, no_telp) VALUES (?, ?, ?)";
...
<head>
    ...
    <title>Tambah Customer - Dewi Cookies</title>
    ...
    <style>
        * {margin: 0;padding: 0;box-sizing: border-box;}
        ...
        small {display: block;margin-top: 8px;color: #8B4513;font-size: 0.85rem;}
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <div><h1><span>➕</span> Tambah Customer</h1><p>Tambahkan customer/pelanggan baru</p></div>
        </div>
        ...
        <div class="content-box">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" placeholder="Contoh: Ibu Sarah" required autofocus>
                </div>
                
                <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <textarea id="alamat" name="alamat" placeholder="Masukkan alamat lengkap customer"></textarea>
                </div>
                
                <div class="form-group">
                    <label for="no_telp">No Telepon</label>
                    <input type="text" id="no_telp" name="no_telp" placeholder="Contoh: 08123456789">
