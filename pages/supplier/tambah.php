...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO supplier (nama, alamat, no_telp, no_rek) VALUES (?, ?, ?, ?)";
...
<head>
    ...
    <title>Tambah Supplier - Dewi Cookies</title>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <div>
                <h1><span>➕</span> Tambah Supplier</h1>
                <p>Tambahkan supplier bahan baku baru</p>
            </div>
        </div>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" 
                           placeholder="Contoh: Toko Bahan Kue Sejahtera" required autofocus>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small>Format: 08xxx atau +62xxx</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small>Format: Bank + Nomor + Atas Nama</small>
                </div>
