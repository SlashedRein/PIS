                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="px-3 text-end">
                                        ...
                                        <a href="?delete=<?php echo $row['id_supp']; ?>" class="btn btn-sm btn-danger rounded-2 btn-action" onclick="return confirm('Hapus data ini?')">
            ...
            <div class="modal-content rounded-4 border-0 shadow">
                ...
                <form method="POST" action="">
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            <label class="form-label fw-bold small">Nama Supplier *</label>
                            <input type="text" class="form-control rounded-3" name="nama" placeholder="Contoh: Toko Sejahtera" required>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <label class="form-label fw-bold small">No Rekening</label>
                                <input type="text" class="form-control rounded-3" name="no_rek" placeholder="Bank - No Rek">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer border-top-0 pt-0 px-4 pb-4">
                        <button type="button" class="btn btn-light rounded-3" data-bs-dismiss="modal">Batal</button>
                        <button type="submit" name="create_supplier" class="btn btn-brown rounded-3 px-4">
                            Simpan
                        </button>
                    </div>
                </form>
                ...
                <form method="POST" action="">
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <label class="form-label fw-bold small">No Rekening</label>
                                <input type="text" class="form-control rounded-3" name="no_rek" id="edit_rek">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer border-top-0 pt-0 px-4 pb-4">
                        <button type="button" class="btn btn-light rounded-3" data-bs-dismiss="modal">Batal</button>
                        <button type="submit" name="update_supplier" class="btn btn-brown rounded-3 px-4">
                            Update Data
                        </button>
                    </div>
                </form>
