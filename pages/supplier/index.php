...
if (isset($_GET['delete'])) {
    ...
    if ($check['count'] > 0) {
        $error = "Supplier tidak bisa dihapus karena masih terdapat transaksi pembelian terkait!";
    } else {
    ...
    <style>
        * {
        ...
        .sidebar {
            ...
            width: 80px;
            height: 100vh;
            background: linear-gradient(180deg, #6F3410 0%, #8B4513 100%);
            color: #FFF8DC;
            padding: 20px 10px;
            overflow: hidden;
        ...
        .logo {
            text-align: center;
            padding-bottom: 20px;
            border-bottom: 2px solid rgba(255,248,220,0.2);
            margin-bottom: 20px;
            white-space: nowrap;
        }
        ...
        .header {
            ...
            border-radius: 20px;
            margin-bottom: 25px;
            box-shadow: 0 4px 20px rgba(111,52,16,0.08);
            display: flex;
        ...
        .btn-primary {
            background: linear-gradient(135deg, #8B4513, #6F3410);
            color: #FFF8DC;
        ...
        tbody tr:hover {
            background: linear-gradient(135deg, #FFF8DC 0%, #F5DEB3 30%);
            transform: translateX(5px);
        }
...
<body>
    <div class="sidebar">
        ...
        <div class="menu-section">
            ...
            <a href="../customer/index.php" class="menu-item">
                <span class="menu-icon">👥</span>
        ...
        <div class="menu-section">
            ...
            <a href="../bahan-baku/index.php" class="menu-item">
                <span class="menu-icon">📦</span>
                <span class="menu-text">Bahan Baku</span>
            </a>
            <a href="../produk/index.php" class="menu-item">
                <span class="menu-icon">🍪</span>
                <span class="menu-text">Produk</span>
            </a>
            <a href="../resep/index.php" class="menu-item">
                <span class="menu-icon">📝</span>
        ...
        <div class="menu-section">
            ...
            <a href="../pembelian/index.php" class="menu-item">
                <span class="menu-icon">🛒</span>
                <span class="menu-text">Pembelian</span>
            </a>
            <a href="../penjualan/index.php" class="menu-item">
                <span class="menu-icon">💰</span>
        ...
        <div class="menu-section">
            ...
            <a href="../laporan/index.php" class="menu-item">
                <span class="menu-icon">📈</span>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?php echo $row['id_supp']; ?>" 
                                   class="btn btn-warning btn-sm">✏️ Edit</a>
                                <a href="?delete=<?php echo $row['id_supp']; ?>" 
                                   class="btn btn-danger btn-sm"
                                   onclick="return confirm('Yakin ingin menghapus supplier ini?')">🗑️ Hapus</a>
                            </td>
                        </tr>
                    <?php 
                        endwhile;
                    ...
                    ?>
                        <tr>
                            <td colspan="6" class="no-data">
                                ...
                                <p style="margin-top: 10px; font-size: 0.9rem;">Klik tombol "Tambah Supplier" untuk menambahkan data</p>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
