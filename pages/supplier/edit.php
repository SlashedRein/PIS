...
$query = "SELECT * FROM supplier WHERE id_supp = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ssssi", $nama, $alamat, $no_telp, $no_rek, $id);
...
<head>
    ...
    <title>Edit Supplier - Dewi Cookies</title>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <div>
                <h1><span>✏️</span> Edit Supplier</h1>
                <p>Update data supplier</p>
            </div>
        </div>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="no_rek" name="no_rek" 
                           value="<?php echo htmlspecialchars($data['no_rek']); ?>">
                </div>
