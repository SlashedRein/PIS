...
$query = "SELECT * FROM bahan_baku WHERE id_bahan = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ssiii", $nama_bahan, $satuan, $stok, $stok_min, $id);
    
    if ($stmt->execute()) {
        $success = "Bahan baku berhasil diupdate!";
...
<head>
    ...
    <title>Edit Bahan Baku - Dewi Cookies</title>
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div class="page-title">
                ...
                <p>Update data bahan baku yang sudah ada</p>
            </div>
        </div>
        ...
        <div class="content-area">
            <div class="info-box">
                ...
                <span>Mengedit: <strong><?php echo htmlspecialchars($data['nama_bahan']); ?></strong></span>
            </div>
                ...
                <form method="POST" action="">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="nama_bahan" name="nama_bahan" 
                               value="<?php echo htmlspecialchars($data['nama_bahan']); ?>" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="stok_min" name="stok_min" 
                               value="<?php echo $data['stok_min']; ?>" min="0" required>
                        <div class="form-text">
