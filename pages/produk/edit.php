...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE produk SET nama_produk = ?, satuan = ?, harga_jual = ?, stok = ? WHERE id_produk = ?";
    $stmt = $conn->prepare($update_query);
    $stmt->bind_param("ssiii", $nama_produk, $satuan, $harga_jual, $stok, $id);
...
<head>
    ...
    <title>Edit Produk - Dewi Cookies</title>
    ...
    <style>
        ...
        * {
        ...
        /* Sidebar Styles - Identik dengan bahan-baku/edit.php */
        .sidebar {
            position: fixed;
            left: 0;
            top: 0;
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div class="page-title">
                ...
                <p>Update data produk yang sudah ada</p>
            </div>
        </div>
        ...
        <div class="content-area">
            <div class="info-box">
                ...
                <span>Mengedit: <strong><?php echo htmlspecialchars($data['nama_produk']); ?></strong></span>
            </div>
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="satuan" name="satuan" required>
                            ...
                            <option value="toples" <?php echo $data['satuan'] == 'toples' ? 'selected' : ''; ?>>Toples</option>
                            <option value="box" <?php echo $data['satuan'] == 'box' ? 'selected' : ''; ?>>Box</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="harga_jual" name="harga_jual" 
                               value="<?php echo $data['harga_jual']; ?>" min="0" step="100" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text">Update jumlah stok terkini</div>
                    </div>
